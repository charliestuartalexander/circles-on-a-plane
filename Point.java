...
public class Point {
    ...
    */
    ...
    public double distance(Point x) {
        double xdis=Math.sqrt(Math.pow((x.X-X),2)+Math.pow((x.Y-Y),2));
        return xdis;
    }
    ...
    public static void main (String args[]) {
        // Tests
        Point A = new Point(4,6.5);
        Point B = new Point(2.8,1.8);
        System.out.println(A.distance(B));
        Point C = new Point(-1.8,3.2);
        Point D = new Point(8.4,-4.9);
